    ...
    for (var b = 0; b < listSize; b++) { 
        ...
        if (!ds_map_exists(global.texName, currentTexture)) {
            if (directory_exists(directoryPath+"textures")) {
                if (file_exists(directoryPath+"textures\tex_"+currentTexture)) {
                    global.textures[array_length_1d(global.textures)] = background_add(directoryPath+"textures\tex_"+currentTexture, false, false);
...
if (ds_list_empty(blockList)) {} else {
    ...
    for (var b = 0; b < listSize; b++) { 
        ...
        var global.currentTexture = file_exists(directoryPath+"textures\tex_"+currentTexture);
        if (!ds_map_exists(global.texName, currentTexture)) {
            if (directory_exists(directoryPath+"textures")) {
                if (file_exists(directoryPath+"textures\tex_"+currentTexture)) {
                    global.textures[array_length_1d(global.textures)] = background_add(directoryPath+"textures\tex_"+currentTexture, false, false);
...
if (ds_list_empty(modelList)) {} else {
    ...
    for (var b = 0; b < listSize; b++) { 
        ...
        var global.currentModel = file_exists(directoryPath+"textures\tex_"+currentTexture);
        if (!ds_map_exists(global.texName, currentModel)) {
            if (directory_exists(directoryPath+"textures")) {
                if (file_exists(directoryPath+"textures\tex_"+currentModel)) {
                    global.textures[array_length_1d(global.textures)] = background_add(directoryPath+"textures\tex_"+currentModel, false, false);
